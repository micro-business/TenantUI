(defproject org.microbusiness/micro-business-tenantui "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main micro-business.tenantui
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/tenantui.js"
               ...
               {:id "test"
                ...
                :compiler {:main micro-business.tenantui
                           ...
                           :output-to "resources/public/js/test/compiled/tenantui.js"
               ...
               {:id "prod"
                :source-paths ["src/cljs"]
                :compiler {:output-to "resources/public/js/compiled/tenantui.js"
                           :main micro-business.tenantui
